package name.wangyan.modules.message.job;

import java.util.List;

import name.wangyan.modules.message.entity.SysMessage;
import name.wangyan.modules.message.handle.ISendMsgHandle;
import name.wangyan.modules.message.handle.enums.SendMsgStatusEnum;
import name.wangyan.modules.message.handle.enums.SendMsgTypeEnum;
...
public class SendMsgJob implements Job {
	...
	public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		...
		log.info(String.format(" wang-yan 发送消息任务 SendMsgJob !  时间:" + DateUtils.getTimestamp()));
