package work.framework.modules.message.job;

import java.util.List;

import work.framework.modules.message.entity.SysMessage;
import work.framework.modules.message.handle.ISendMsgHandle;
import work.framework.modules.message.handle.enums.SendMsgStatusEnum;
import work.framework.modules.message.handle.enums.SendMsgTypeEnum;
